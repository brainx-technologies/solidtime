...
class JetstreamServiceProvider extends ServiceProvider
{
    ...
    protected function configurePermissions(): void
    {
        ...
        Jetstream::role(Role::Owner->value, 'Owner', [
            ...
            'members:merge-into',
            'members:update',
            'member:time-entry-override:view',
            'member:time-entry-override:create:all',
            'member:time-entry-override:update:all',
            'member:time-entry-override:delete:all',
            'members:delete',
            'billing',
            'reports:view',
            'reports:create',
        ...
        Jetstream::role(Role::HR->value, 'HR', [
            ...
            'members:view',
            'member:time-entry-override:view',
            'member:time-entry-override:create:all_except_own',
            'member:time-entry-override:update:all_except_own',
            'member:time-entry-override:delete:all_except_own',
            'reports:view',
            'reports:create',
            'reports:update',
            'reports:delete',
